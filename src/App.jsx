          ...
          {todos.map(todo => {
            return(
              <li key={todo.id} className="task bg-slate-100 rounded-lg px-4 py-2 mt-2 flex items-center">
                ...
                <button onClick={ () => deleteTodo(todo.id)} class="inline-flex items-center justify-center w-8 h-8 mr-2 text-pink-100 transition-colors duration-150 bg-rose-600 rounded-full focus:shadow-outline hover:bg-rose-700">
